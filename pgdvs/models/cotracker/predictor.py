...
from pgdvs.models.cotracker.models.core.cotracker.cotracker import (
    get_points_on_a_grid,
)
from pgdvs.models.cotracker.models.core.model_utils import smart_cat
from pgdvs.models.cotracker.models.build_cotracker import (
    build_cotracker,
)
...
class CoTrackerPredictor(torch.nn.Module):
    ...
    def _compute_dense_tracks(
        ...
        *_, H, W = video.shape
        ...
        for offset in tqdm(range(grid_step * grid_step), disable=True):
            ox = offset % grid_step
            oy = offset // grid_step
            grid_pts[0, :, 1] = (
